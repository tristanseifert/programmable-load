...
typedef union { // __I to avoid read-modify-write on write-to-clear register
  struct {
    ...
    __I uint8_t  reserved:5;               /*!< bit:  2.. 6  Reserved                           */
...
typedef union { // __I to avoid read-modify-write on write-to-clear register
  struct {
    ...
    __I uint8_t  reserved:4;               /*!< bit:  3.. 6  Reserved                           */
    __I uint8_t  ERROR:1;          /*!< bit:      7  Combined Error Interrupt           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint8_t reg;                 /*!< Type      used for register access              */
...
typedef union { // __I to avoid read-modify-write on write-to-clear register
  struct {
    ...
    __I uint8_t  reserved:3;               /*!< bit:  4.. 6  Reserved                           */
    __I uint8_t  ERROR:1;          /*!< bit:      7  Combined Error Interrupt           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint8_t reg;                 /*!< Type      used for register access              */
...
typedef union { // __I to avoid read-modify-write on write-to-clear register
  struct {
    ...
    __I uint8_t  reserved:1;               /*!< bit:      6  Reserved                           */
    __I uint8_t  ERROR:1;          /*!< bit:      7  Combined Error Interrupt           */
  } bit;                       /*!< Structure used for bit  access                  */
  uint8_t reg;                 /*!< Type      used for register access              */
