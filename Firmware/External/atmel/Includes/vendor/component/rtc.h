...
typedef union { // __I to avoid read-modify-write on write-to-clear register
  struct {
    ...
    __I uint16_t reserved:4;               /*!< bit: 10..13  Reserved                           */
  ...
  struct {
    ...
    __I uint16_t reserved:6;               /*!< bit: 10..15  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint16_t reg;                /*!< Type      used for register access              */
...
typedef union { // __I to avoid read-modify-write on write-to-clear register
  struct {
    ...
    __I uint16_t reserved:2;               /*!< bit: 12..13  Reserved                           */
    __I uint16_t TAMPER:1;         /*!< bit:     14  Tamper                             */
    __I uint16_t OVF:1;            /*!< bit:     15  Overflow                           */
  } bit;                       /*!< Structure used for bit  access                  */
  struct {
    ...
    __I uint16_t reserved:4;               /*!< bit: 12..15  Reserved                           */
  } vec;                       /*!< Structure used for vec  access                  */
  uint16_t reg;                /*!< Type      used for register access              */
